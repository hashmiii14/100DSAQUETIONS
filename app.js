        ...
        <div style="margin-top: 16px;">
          <div style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px; margin-bottom: 6px;">
            <div class="lang-tabs" role="tablist" aria-label="Programming Language Code Tabs">
              <button class="lang-tab ${this.activeLang === 'cpp' ? 'active' : ''}" role="tab" aria-selected="${this.activeLang === 'cpp' ? 'true' : 'false'}" onclick="app.setModalLang('cpp')">C++</button>
              <button class="lang-tab ${this.activeLang === 'java' ? 'active' : ''}" role="tab" aria-selected="${this.activeLang === 'java' ? 'true' : 'false'}" onclick="app.setModalLang('java')">Java</button>
              <button class="lang-tab ${this.activeLang === 'python' ? 'active' : ''}" role="tab" aria-selected="${this.activeLang === 'python' ? 'true' : 'false'}" onclick="app.setModalLang('python')">Python</button>
              <button class="lang-tab ${this.activeLang === 'javascript' ? 'active' : ''}" role="tab" aria-selected="${this.activeLang === 'javascript' ? 'true' : 'false'}" onclick="app.setModalLang('javascript')">JavaScript</button>
            </div>
